...
if not TMDB_API_KEY:
    ...
    raise RuntimeError("TMDB_API_KEY missing. Put it in .env as TMDB_API_KEY=e290d6354b6f6c9b5643035e318d0fe6")
...
async def tmdb_get(path: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=502,
            detail=f"TMDB request error: {type(e)._name_} | {repr(e)}",
        )
